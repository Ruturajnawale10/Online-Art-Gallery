...
<div>
  ...
  $title = "Human expresssion 8784 Painting";
  ...
  <div class="container overview">
    <div class="row" style="margin-top: 20px">
      <div class="col-auto">
        <img src="../images/img5.jpg" alt="img" style="max-width: 700px" />
      </div>
      <div class="col-md-4 block">
        <h2 class="paintingtitle">Human expresssion 8784 Painting</h2>
        <h3 class="author">Lily Cash</h3>
        <h4>United States</h4>
        <h4 class="paintingtype">Painting, Acrylic on Canvas</h4>
        <h4>Size: 34 W x 24 H x 1.5 D in</h4>

        <h4 class="price">$ 4,100</h4>
        <h4>Buy now</h4>
